...
module.exports = [
  ...
  },
  {
    ...
    path: 'seiseiai',
    title: '生成AIパスポートチャット',
    shortTitle: '生成AIパスポート',
    icon: '✨',
    themeColor: '#6a3fa0',
    themeColorDark: '#3d2359',
    welcomeHeadline: '生成AIパスポートの質問にお答えします',
    welcomeBody: 'AIの基礎・生成AIの仕組み・リスクと対策・情報リテラシー・プロンプト制作・企業活用など、生成AIパスポートの頻出論点について聞いてください。',
    portalDesc: '生成AIの仕組み・リスクと対策・プロンプト制作・企業活用など、生成AIパスポートの頻出論点をチャットで質問できます。',
    suggestions: [
      'ハルシネーションとは？',
